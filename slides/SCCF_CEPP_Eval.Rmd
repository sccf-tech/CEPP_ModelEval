...
regq.dat.CY.mean%>%
  ...
  add_header("ECB"="Average annual total discharge",
             "FWO"="Average annual total discharge",
             "C240"="Average annual total discharge",
...
### Add estuary salinity envelope metrics